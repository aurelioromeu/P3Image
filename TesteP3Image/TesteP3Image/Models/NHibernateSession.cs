...
namespace TesteP3Image.Models
{
    public class NHibernateSession
    {
        public static ISession OpenSession()
        {
            ...
            //configuration.Configure(configurationPath.ToString().Replace("Admin", "TesteP3Image"));
            configuration.Configure(configurationPath.ToString().Replace("Publico", "TesteP3Image"));
            //configuration.Configure(configurationPath.ToString().Replace("Admin.Tests", "TesteP3Image"));
